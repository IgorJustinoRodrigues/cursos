            ...
            <div class="mdk-header__content">
                ...
                <nav id="default-navbar" class="navbar navbar-expand navbar-dark bg-success m-0">
                    <div class="container-fluid">
                        ...
                        <!-- Brand -->
                        <a href="{{ route('painelUnidade') }}" class="navbar-brand">
                        ...
                        <ul class="nav navbar-nav flex-nowrap">
                            ...
                            <li class="nav-item dropdown ml-1 ml-md-3">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item" href="{{ route('painelUnidade') }}">
                                        <i class="material-icons">person</i> Perfil
                                    </a>
                                    <a class="dropdown-item"
                                        href="{{ route('minhaContaUnidade', $_SESSION['unidade_cursos_start']->id) }}">
                                        <i class="material-icons">edit</i> Editar Conta
                                    </a>
                                    <a class="dropdown-item" href="{{ route('sairUnidade') }}">
                                        <i class="material-icons">lock</i> Sair
                                    </a>
                                    <p class="dropdown-item" style="font-size: 10px">
                                        Último acesso
                                        em:<br>{{ $_SESSION['unidade_cursos_start']->ultimo_acesso_unidade }}
                                    </p>
                                </div>
                            </li>
                            <!-- // END User dropdown -->
