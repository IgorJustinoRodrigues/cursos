    ...
    <div class="page ">
        <div class="container page__container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('vendedor.ajuda') }}">Ajuda</a></li>
                            ...
                            @foreach ($telasAtual as $linha)
                                <li class="list-group-item @if ($linha->id == $ajuda->id) active @endif">
                                    <div class="media-left">
                                        <a class="@if ($linha->id == $ajuda->id) text-white @endif" href="{{ route('vendedor.verAjuda', [$linha->id, Str::slug($linha->nome, '-') . '.html']) }}">{{ $linha->nome }}</a>
                                    </div>
                                </li>
                            @endforeach
                        </ul>
                    </div>
                    <a href="{{ route('vendedor.ajuda') }}" class="btn btn-default btn-wide">Voltar</a>
                </div>
            </div>
