...
@section('footer')
    ...
    <script src="{{ URL::asset('painelAdmin/js/telas/admin/cadastro.js') }}"></script>
...
@section('help')
    ...
    A tela de cadastro é usada para inserir um novo registro de Administrador<br><br>
    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-body p-20">
                <form class="p-20" method="POST" action="{{route('adminInserir')}}" enctype="multipart/form-data">
                    @csrf
                    <h5 class="underline mt-n">Cadastro de Administrador</h5>

                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="nome">Nome<sup class='color-danger'>*</sup></label>
                                <input type="text" class="form-control" id="nome" placeholder="Nome" value="{{old('nome')}}" name="nome" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" id="senha" placeholder="*****" value="{{old('senha')}}" name="senha" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="anotacoes">Anotações</label>
                                <textarea class="form-control" id="anotacoes" name="anotacoes">{{old('anotacoes')}}</textarea>
                            </div>
                        </div>
                    </div>
