...
@section('conteudo')
    <div class="col-md-12">
        ...
        <div class="card card-body">
            <div class="row">
                <div class="col-lg-12">
                    <form method="POST" action="{{ route('matriculaInserir') }}">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="col-12 col-md-3 mb-3">
                                ...
                                <select id="tipo_pagamento" class="form-control custom-select" name="tipo_pagamento" onchange="tipoPagamento()">
                            ...
                            <div class="col-12 col-md-3 mb-3 parcelado d-none">
                                ...
                                <input type="number" class="form-control" id="quant_parcelas" name="quant_parcelas_venda" min="1" max="24" step="1"
                                    value="2">
                            </div>
                            <div class="col-12 col-md-3 mb-3 parcelado d-none">
                                <label class="form-label" for="mes_inicio_pagamento">Primeiro pagamento em</label>
                                <select id="mes_inicio_pagamento" class="form-control custom-select" name="mes_inicio_pagamento">
                                    <option @if (old('mes_inicio_pagamento') == 1) selected @endif value="{{ app(App\Services\Services::class)->primeiro_pagamento(true, true, true) }}">{{ app(App\Services\Services::class)->primeiro_pagamento(true) }}</option>
                                    <option @if (old('mes_inicio_pagamento') == 2) selected @endif value="{{ app(App\Services\Services::class)->primeiro_pagamento(true, true, true, true) }}">{{ app(App\Services\Services::class)->primeiro_pagamento(true, true) }}</option>
                                </select>
                            </div>
                            <div class="col-12 col-md-3 mb-3">
                                <label class="form-label" for="valor">Valor de Venda</label>
                                <input type="text" class="form-control dinheiro" id="valor" name="valor_venda" placeholder="Valor"
