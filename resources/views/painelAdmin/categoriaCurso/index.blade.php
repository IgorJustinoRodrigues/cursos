...
@section('conteudo')
    <div class="col-md-12">
        ...
        <div class="d-flex align-items-center mb-4">
            <h1 class="h2 flex mr-3 mb-0">Listagem de Categoria de Curso</h1>
            <a href="{{ route('categoriaCursoCadastro') }}" class="btn btn-success">Cadastro</a>
        </div>
        ...
        <div class="mb-4 d-flex align-items-center">
            ...
            <form class="flex search-form form-control-rounded search-form--light mb-2 col-md-12"
                action="{{ route('categoriaCursoIndex') }}" method="GET" style="min-width: 200px;">
                ...
                @if (@$busca)
                    <a href="{{ route('categoriaCursoIndex') }}" class="btn pr-3 text-danger" type="button"
                    ...
                    @foreach ($paginacao as $item)
                        <tr>
                            ...
                            <td class="table-dropdown text-center">
                                <a href="{{ route('categoriaCursoEditar', $item->id) }}" class="btn btn-success">
                                    <i class="fa fa-edit"></i>
                                </a>

                                <a onclick="confirmacao('{{ route('categoriaCursoDeletar', $item->id) }}', '<h3>Realmente deseja excluir esse categoriaCurso?</h3><p>{{ $item->nome }}</p>')"
