                    ...
                    @foreach ($paginacao as $item)
                        <tr>
                            <td class="text-center">
                                <a href="{{ route('editarUnidadeParceiro', $item->id) }}">
                                    @if ($item->logo != '')
                            ...
                            <td class="table-dropdown text-center">
                                <a href="{{ route('editarUnidadeParceiro', $item->id) }}" class="btn btn-success">
                                    <i class="fa fa-edit"></i>
                                </a>

                                <a onclick="confirmacao('{{ route('deletarUnidadeParceiro', $item->id) }}', '<h3>Realmente deseja excluir esse unidade?</h3><p>{{ $item->nome }}</p>')"
