...
@section('conteudo')
    <div class="col-md-12">
        ...
        <div class="card card-body">
            <div class="row">
                <div class="col-lg-12">
                    <form method="POST" action="{{ route('inserirUnidadeParceiro') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <div class="col-md-12">
                                    <select id="estado" name="estado" class="form-control">
                                        ...
                                        <option value="AL" @if (old('estado') == 'AL') selected @endif>Alagoas
                                        </option>
                                        <option value="AP" @if (old('estado') == 'AP') selected @endif>Amapá</option>
                                        <option value="AM" @if (old('estado') == 'AM') selected @endif>Amazonas
                                        </option>
                                        ...
                                        <option value="DF" @if (old('estado') == 'DF') selected @endif>Distrito
                                            Federal</option>
                                        <option value="ES" @if (old('estado') == 'ES') selected @endif>Espírito Santo
                                        </option>
                                        ...
                                        <option value="PB" @if (old('estado') == 'PB') selected @endif>Paraíba
                                        </option>
                                        <option value="PR" @if (old('estado') == 'PR') selected @endif>Paraná
                                        </option>
                                        <option value="PE" @if (old('estado') == 'PE') selected @endif>Pernambuco
                                        </option>
                                        <option value="PI" @if (old('estado') == 'PI') selected @endif>Piauí
                                        </option>
                                        <option value="RJ" @if (old('estado') == 'RJ') selected @endif>Rio de
                                            Janeiro</option>
                                        <option value="RN" @if (old('estado') == 'RN') selected @endif>Rio Grande do
                                            Norte</option>
                                        <option value="RS" @if (old('estado') == 'RS') selected @endif>Rio Grande do
                                            Sul</option>
                                        <option value="RO" @if (old('estado') == 'RO') selected @endif>Rondônia
                                        </option>
                                        <option value="RR" @if (old('estado') == 'RR') selected @endif>Roraima
                                        </option>
                                        <option value="SC" @if (old('estado') == 'SC') selected @endif>Santa
                                            Catarina</option>
                                        <option value="SP" @if (old('estado') == 'SP') selected @endif>São Paulo
                                        </option>
                                        <option value="SE" @if (old('estado') == 'SE') selected @endif>Sergipe
                                        </option>
